...
M00_L01:
       ...
       je        short M00_L00
       mov       rdx,rax
       jmp       qword ptr [7FFB0E4EE148]; Relay.DispatchSink`1[[Relay.Benchmarks.Entry64, Relay.Benchmarks]].Enqueue(Relay.Benchmarks.Entry64 ByRef)
...
; Relay.Benchmarks.EnqueueBenchmarks.Depth2_AcceptReject()
       ...
       je        short M00_L00
       mov       rdx,rax
       jmp       qword ptr [7FFB0E4FE130]; Relay.DispatchSink`1[[Relay.Benchmarks.Entry64, Relay.Benchmarks]].Enqueue(Relay.Benchmarks.Entry64 ByRef)
M00_L00:
       ret
...
; Relay.Benchmarks.EnqueueBenchmarks.Depth2_HeadUnhealthy()
       ...
       je        short M00_L00
       mov       rdx,rax
       jmp       qword ptr [7FFB0E50E130]; Relay.DispatchSink`1[[Relay.Benchmarks.Entry64, Relay.Benchmarks]].Enqueue(Relay.Benchmarks.Entry64 ByRef)
M00_L00:
       ret
; Total bytes of code 30
```
