...
M00_L00:
       mov       rcx,rbx
       cmp       [rcx],ecx
       call      qword ptr [7FFB0E4B13F0]; Relay.MultiSink.get_IsHealthy()
       test      eax,eax
       je        short M00_L04
       mov       [rsp+20],rsi
       mov       [rsp+28],edi
       lea       rdx,[rsp+20]
       mov       rcx,rbx
       call      qword ptr [7FFB0E4B13F8]; Relay.MultiSink.Accept(System.ReadOnlySpan`1<Byte>)
       test      eax,eax
       je        short M00_L04
...
M00_L03:
       ...
       mov       [rsp+28],edi
       lea       rdx,[rsp+20]
       call      qword ptr [7FFB0E4DDE00]; Relay.PacketSink.Enqueue(System.ReadOnlySpan`1<Byte>)
       jmp       short M00_L01
M00_L04:
       mov       rcx,[rbx+8]
       test      rcx,rcx
...
M00_L00:
       mov       rcx,rbx
       cmp       [rcx],ecx
       call      qword ptr [7FFB0E4E17F8]; Relay.Multi2PacketSink`2[[System.__Canon, System.Private.CoreLib],[System.__Canon, System.Private.CoreLib]].get_IsHealthy()
       test      eax,eax
       je        short M00_L04
       mov       rcx,[rbx+20]
       mov       [rsp+20],rsi
       ...
       lea       rdx,[rsp+20]
       cmp       [rcx],ecx
       call      qword ptr [7FFB0E50DDE8]; Relay.PacketSink.Enqueue(System.ReadOnlySpan`1<Byte>)
       mov       rcx,[rbx+28]
       mov       [rsp+20],rsi
       mov       [rsp+28],edi
       lea       rdx,[rsp+20]
