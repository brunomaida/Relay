...
M00_L05:
       ...
       mov       [rsp+30],edi
       lea       rdx,[rsp+28]
       call      qword ptr [7FFB0E48DE78]; Relay.PacketSink.Enqueue(System.ReadOnlySpan`1<Byte>)
       jmp       short M00_L02
M00_L06:
       mov       rcx,[rbx+8]
       test      rcx,rcx
...
M00_L03:
       ...
       mov       [rsp+30],edi
       lea       rdx,[rsp+28]
       call      qword ptr [7FFB0E49DE78]; Relay.PacketSink.Enqueue(System.ReadOnlySpan`1<Byte>)
M00_L04:
       nop
       add       rsp,38
       pop       rbx
...
M00_L05:
       ...
       mov       [rsp+30],edi
       lea       rdx,[rsp+28]
       call      qword ptr [7FFB0E47DE60]; Relay.PacketSink.Enqueue(System.ReadOnlySpan`1<Byte>)
       jmp       short M00_L02
M00_L06:
       mov       [rsp+28],rsi
       mov       [rsp+30],edi
...
M00_L04:
       ...
       mov       [rsp+28],edi
       lea       rdx,[rsp+20]
       call      qword ptr [7FFB0E48DE60]; Relay.PacketSink.Enqueue(System.ReadOnlySpan`1<Byte>)
       jmp       short M00_L02
M00_L05:
       mov       [rsp+20],rsi
       mov       [rsp+28],edi
...
M00_L04:
       ...
       mov       [rsp+30],edi
       lea       rdx,[rsp+28]
       call      qword ptr [7FFB0E49DE60]; Relay.PacketSink.Enqueue(System.ReadOnlySpan`1<Byte>)
       jmp       short M00_L02
M00_L05:
       mov       [rsp+28],rsi
       mov       [rsp+30],edi
