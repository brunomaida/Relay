...
public class TcpSinkBenchmark
{
    ...
    [Benchmark]
    public void TcpSink_Enqueue_128B() => _sink!.Enqueue(_payload);
}
```
...
public class ChainBenchmark
{
    ...
    public void Setup()
    {
        _l1 = StartListener(); _l2 = StartListener(); _l3 = StartListener();
    ...
    public void Cleanup()
    {
        ...
        _l1?.Stop(); _l2?.Stop(); _l3?.Stop();
    }

    [Benchmark(Baseline = true)]
    public void TcpSink_NoPropagation() => _tcp!.Enqueue(_payload);
