...
# Benchmarks
Benchmarks: methodology (run commands, regression/noise thresholds, gating) = `docs/bench-methodology.md`.
Source of current/historical numbers = `docs/reports/bench-history/bench-history.md` (generated by the
`bench-report` skill; never edit by hand). Regenerate: `/bench-report ingest`.
