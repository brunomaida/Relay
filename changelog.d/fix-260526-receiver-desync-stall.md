...
### Audit
Findings F0 / F0b from `docs/reports/2026-05-26-hot-path-audit-receivers.md` (hot-path-audit, post v1.0.2). Both classified `HIGH — correctness` (not perf). Regression tests in `tests/Relay.Tests/Receivers/ReceiverDesyncStallTests.cs` cover negative-length, oversized-length, and wrong-magic cases for all three receivers.
